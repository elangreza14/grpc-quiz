...
func (x *StreamResponse) GetClientRegister() *StreamResponse_Register {
	if x, ok := x.GetEvent().(*StreamResponse_ClientRegister); ok {
		return x.ClientRegister
	}
	return nil
}

func (x *StreamResponse) GetServerAnnouncement() *StreamResponse_Message {
...
type StreamResponse_ClientRegister struct {
	ClientRegister *StreamResponse_Register `protobuf:"bytes,2,opt,name=client_register,json=clientRegister,proto3,oneof"`
}

type StreamResponse_ServerAnnouncement struct {
	ServerAnnouncement *StreamResponse_Message `protobuf:"bytes,3,opt,name=server_announcement,json=serverAnnouncement,proto3,oneof"`
}

type StreamResponse_ServerShutdown struct {
	ServerShutdown *StreamResponse_Shutdown `protobuf:"bytes,4,opt,name=server_shutdown,json=serverShutdown,proto3,oneof"`
}

func (*StreamResponse_ClientRegister) isStreamResponse_Event() {}

func (*StreamResponse_ServerAnnouncement) isStreamResponse_Event() {}

func (*StreamResponse_ServerShutdown) isStreamResponse_Event() {}

type StreamResponse_Register struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StreamResponse_Register) Reset() {
	*x = StreamResponse_Register{}
	if protoimpl.UnsafeEnabled {
...
func (x *StreamResponse_Register) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamResponse_Register) ProtoMessage() {}

func (x *StreamResponse_Register) ProtoReflect() protoreflect.Message {
	mi := &file_proto_quiz_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamResponse_Register.ProtoReflect.Descriptor instead.
func (*StreamResponse_Register) Descriptor() ([]byte, []int) {
	return file_proto_quiz_proto_rawDescGZIP(), []int{3, 0}
}

func (x *StreamResponse_Register) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (*StreamResponse_Message) Descriptor() ([]byte, []int) {
	return file_proto_quiz_proto_rawDescGZIP(), []int{3, 1}
}
...
func (*StreamResponse_Shutdown) Descriptor() ([]byte, []int) {
	return file_proto_quiz_proto_rawDescGZIP(), []int{3, 2}
}
...
var file_proto_quiz_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x42, 0x0a, 0x0f, 0x52, 0x65, 0x67,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2c, 0x0a,
	...
	,
	...
	,
	...
	0x2f, 0x65, 0x6c, 0x61, 0x6e, 0x67, 0x72, 0x65, 0x7a, 0x61, 0x31, 0x34, 0x2f, 0x67, 0x72, 0x70,
	0x63, 0x2d, 0x71, 0x75, 0x69, 0x7a, 0x2f, 0x71, 0x75, 0x69, 0x7a, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_proto_quiz_proto_goTypes = []interface{}{
	...
	(*RegisterResponse)(nil),        // 1: quiz.RegisterResponse
	(*StreamRequest)(nil),           // 2: quiz.StreamRequest
	(*StreamResponse)(nil),          // 3: quiz.StreamResponse
	(*StreamResponse_Register)(nil), // 4: quiz.StreamResponse.Register
	(*StreamResponse_Message)(nil),  // 5: quiz.StreamResponse.Message
	(*StreamResponse_Shutdown)(nil), // 6: quiz.StreamResponse.Shutdown
	(*timestamppb.Timestamp)(nil),   // 7: google.protobuf.Timestamp
}
var file_proto_quiz_proto_depIdxs = []int32{
	7, // 0: quiz.StreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	4, // 1: quiz.StreamResponse.client_register:type_name -> quiz.StreamResponse.Register
	5, // 2: quiz.StreamResponse.server_announcement:type_name -> quiz.StreamResponse.Message
	6, // 3: quiz.StreamResponse.server_shutdown:type_name -> quiz.StreamResponse.Shutdown
	0, // 4: quiz.Quiz.Register:input_type -> quiz.RegisterRequest
	2, // 5: quiz.Quiz.Stream:input_type -> quiz.StreamRequest
	1, // 6: quiz.Quiz.Register:output_type -> quiz.RegisterResponse
	3, // 7: quiz.Quiz.Stream:output_type -> quiz.StreamResponse
...
func file_proto_quiz_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_quiz_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamResponse_Register); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proto_quiz_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*StreamResponse_ClientRegister)(nil),
